import type { CheckResult, CommandOptions, FixResult, ReportOptions, Issue, Change } from '../../types/index.js';
...
export const check = async (options: DepsCheckOptions): Promise<CheckResult> => {
...
export const fix = async (options: DepsFixOptions): Promise<FixResult> => {
...
export const update = async (options: DepsUpdateOptions): Promise<void> => {
