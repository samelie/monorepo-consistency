import type { CommandOptions, FixResult, Issue, ReportOptions } from "../../types/index.js";
...
const check = async (options: HealthCheckOptions): Promise<HealthResult> => {
...
const fix = async (options: HealthFixOptions): Promise<FixResult> => {
